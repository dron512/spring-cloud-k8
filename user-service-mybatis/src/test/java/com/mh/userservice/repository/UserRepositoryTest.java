...
class UserRepositoryTest {
    ...
    public void memberSaveTest1() {
        userRepository.save(new UserMapperDto(null, "mybatis회원이메일", "mybatis회원비밀번호", "mybatis회원이름"));
    }
    ...
    public void memberSaveTest2() {
        userRepository.save2(new UserMapperDto(null, "mybatis회원이메일", "mybatis회원비밀번호", "mybatis회원이름"));
    }
}